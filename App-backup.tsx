             ...
             <div className="space-y-4">
                ...
                <div className="grid gap-3">
                  {filteredAdminClients.map(client => (
                    <div key={client.id} className="bg-[#16161a] p-4 rounded-xl flex justify-between items-center border border-slate-900">
                      ...
                      <div className="flex gap-2">
                        <button onClick={() => copyToClipboard(client.id)} id={`copy-${client.id}`} className="w-10 h-10 bg-slate-900 text-slate-500 rounded-lg border border-slate-800 flex items-center justify-center">📋</button>
                        <button onClick={() => handleRemoveClient(client.id)} className="w-10 h-10 bg-slate-900 text-red-900 rounded-lg border border-slate-800 flex items-center justify-center">✕</button>
                      </div>
                    </div>
                  ))}
                </div>
